...
exports.exportSolutionSingle = exports.beginExportSolution = exports.createAnnotationRecord = exports.createExportStatusRecord = exports.getUnmanagedSolutions = exports.createSolutionRecord = exports.retrieveSolutionDeploymentOrder = void 0;
var solORders = new Array();
//export namespace MCS.DevOps.Web {
function retrieveSolutionDeploymentOrder(recordId) {
...
exports.retrieveSolutionDeploymentOrder = retrieveSolutionDeploymentOrder;
...
exports.createSolutionRecord = createSolutionRecord;
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            return [2 /*return*/, new Promise(function (resolve) { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, window.parent.Xrm.WebApi.online.retrieveMultipleRecords("solution", "?$select=solutionid,friendlyname,ismanaged,uniquename,version&$filter=ismanaged eq false&$orderby=createdon desc")];
                            case 1:
                                result = _a.sent();
...
exports.getUnmanagedSolutions = getUnmanagedSolutions;
function createExportStatusRecord(filename, exportStatus, solutionOrder) {
    return __awaiter(this, void 0, void 0, function () {
...
exports.createExportStatusRecord = createExportStatusRecord;
function createAnnotationRecord(fileBase64, filename, solutionOrder) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, createExportStatusRecord(filename, "Completed", solutionOrder)];
                case 1:
...
exports.createAnnotationRecord = createAnnotationRecord;
function beginExportSolution() {
    return __awaiter(this, void 0, void 0, function () {
        var decoder, i, response, kk, fileBase64, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    _a.label = 1;
                case 1:
                    if (!(i < solORders.length)) return [3 /*break*/, 5];
                ...
                case 2:
                    response = _a.sent();
                    kk = JSON.parse(response.responseText).ExportSolutionFile;
                    fileBase64 = kk;
                    localStorage.getItem("exportmanaged");
                    return [4 /*yield*/, createAnnotationRecord(fileBase64, solORders[i][1] + '.zip', i)];
                case 3:
                    _a.sent();
...
exports.beginExportSolution = beginExportSolution;
...
exports.exportSolutionSingle = exportSolutionSingle;
//}
